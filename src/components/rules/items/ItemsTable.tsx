...
import type { SrdItemListItem } from '@/services/rules/items.service'

type Props = {
  data: SrdItemListItem[]
}
...
export function ItemsTable({ data }: Props) {
  ...
  const columns: ColumnDef<SrdItemListItem>[] = [
    {
      accessorKey: 'name',
      header: 'Name',
    },
      ...
      cell: ({ row }) => {
        ...
        return (
          <Button variant="ghost" size="icon" asChild>
            <Link
              to="/rules/items/$itemIndex"
              params={{ itemIndex: item.index }}
            >
